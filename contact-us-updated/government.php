        ...
        <div class="layout-col col-sm-6 col-xs-12">
          <div id="formElement0" class="elq-field-style form-element-layout row">
            <div style="text-align:left;" class="col-sm-12 col-xs-12">
              <label class="elq-label " for="fe47018">First Name
      ...
      <div class="grid-layout-col">
        <div class="layout-col col-sm-6 col-xs-12">
          <div id="formElement1" class="elq-field-style form-element-layout row">
            <div style="text-align:left;" class="col-sm-12 col-xs-12">
              <label class="elq-label " for="fe47019">Last Name
                <span class="elq-required">*
                </span>
              </label>
            </div>
          ...
          <div id="formElement4" class="elq-field-style form-element-layout row">
            ...
            <div class="col-sm-12 col-xs-12">
              <div class="row">
                <div class="col-xs-12">
                  <div class="field-control-wrapper">
                    <input type="text" class="elq-item-input" name="title" id="fe47022" value="" style="width:100%;">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div id="formElement6" class="elq-field-style form-element-layout row">
            ...
            <div class="col-sm-12 col-xs-12">
              <div class="row">
                <div class="col-xs-12">
                  <div class="field-control-wrapper">
                    <select class="elq-item-select" id="fe47032" name="stateProv" style="width:100%;" data-value="~~eloqua..type--emailfield..syntax--State_Prov~~">
                      <option value="">-- State or Province --
                      </option>
...
<script>function handleFormSubmit(ele) {
  ...
  var form = document.getElementById('form2655');
  addChangeHandler(form.getElementsByTagName('input'));
  addChangeHandler(form.getElementsByTagName('select'));
  addChangeHandler(form.getElementsByTagName('textarea'));
  var nodes = document.querySelectorAll('#form2655 input[data-subscription]');
  if (nodes) {
  ...
  var nodes = document.querySelectorAll('#form2655 select[data-value]');
  if (nodes) {
  ...
  var dom0 = document.querySelector('#form2655 #fe47018');
  var fe47018 = new LiveValidation(dom0, {
    validMessage: "", onlyOnBlur: false, wait: 300, isPhoneField: false}
                                  );
  fe47018.add(Validate.Custom, {
  ...
  fe47018.add(Validate.Length, {
    tooShortMessage:"Invalid length for field value", tooLongMessage: "Invalid length for field value",  minimum: 0, maximum: 32}
             );
  fe47018.add(Validate.Presence, {
    failureMessage:"This field is required"}
             );
  var dom1 = document.querySelector('#form2655 #fe47019');
  var fe47019 = new LiveValidation(dom1, {
    validMessage: "", onlyOnBlur: false, wait: 300, isPhoneField: false}
                                  );
  fe47019.add(Validate.Custom, {
    against: function(value) {
      return !value.match(/(telnet|ftp|https?):\/\/(?:[a-z0-9][a-z0-9-]{0,61}[a-z0-9]\.|[a-z0-9]\.)+[a-z]{2,63}/i);
    }
    , failureMessage: "Value must not contain any URL's"}
...
<script>document.onload = handleDocumentLoad('form2655','1913652004');
